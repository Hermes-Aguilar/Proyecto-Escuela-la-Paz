...
const SUPERIORAS: {
  ...
  },
  {
    ...
    foto: "/images/gobierno-1986-1992.jpg",
    fotoAlt: "Gobierno General de la Congregación, periodo 1986–1992",
    gobierno: [
  ...
  },
  {
    ...
    foto: "/images/superiora-lucero-rosario.png",
    fotoAlt: "Visita de la Superiora General M. Ma. del Carmen Lucero Rosario al Jardín de Niños Nazareth",
    gobierno: [
            ...
            <AnimacionScroll key={i} delay={(i % 2) * 100}>
              <article className="overflow-hidden rounded-2xl border border-arena bg-white shadow-sm">
                <div className="border-l-4 border-dorado p-7 md:p-8">
                  ...
                  {/* Foto (de la Superiora o de su gobierno general) */}
                  {s.foto && (
                    <figure className="mt-5 overflow-hidden rounded-xl border border-arena bg-crema">
                      <Image
                        src={s.foto}
                      ...
                      />
                      {s.fotoAlt && (
                        <figcaption className="px-4 py-2 text-center text-xs italic text-marron-suave">
                          {s.fotoAlt}
                        </figcaption>
                      )}
                    </figure>
                  ...
                  <div className="mt-4 space-y-4 text-justify leading-relaxed text-marron-suave">
                    {s.obras.map((o, j) => (
                      <p key={j}>{o}</p>
                    ))}
                  </div>
